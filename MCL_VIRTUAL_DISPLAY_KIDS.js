...
document.write("<table class='table table-hover' cellpadding='0' style='margin-bottom: 5px;' width='100%'><thead><tr><th>Date</th><th>Time</th><th>Title</th></tr></thead>");
...
for (i=0, c=0; i<evtArray.length, c<=10; i++)
{
  ...
  if (event_type == "Children's Program" | event_type == "Ages 5 and Under")
  {
  {
    document.write("<tr>");
